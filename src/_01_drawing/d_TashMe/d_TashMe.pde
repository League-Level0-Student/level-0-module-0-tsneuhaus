...
PImage face;
PImage mustache;
int mustacheWidth = 80;
int mustacheHeight = 40;
...
face = loadImage("HPIM0657 reduced.JPG");
...
if (mousePressed)
  image (mustache, mouseX - mustacheWidth/2,mouseY - mustacheHeight/2);
