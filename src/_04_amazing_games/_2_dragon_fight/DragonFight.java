	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
			String attackType = JOptionPane.showInputDialog("Do you want to attach with a yell or a kick?");
			...
			if (dragonHealth <= 0 )
				...
				// 		dragon have left.
			JOptionPane.showMessageDialog(null, "Player has " + playerHealth + " health left and dragon has " + 
									dragonHealth + " left.");
